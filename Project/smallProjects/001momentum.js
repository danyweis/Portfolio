...
function backGround() {
    ...
    if (hours < 12) {
        ...
        body.style.backgroundImage = "url(001momentumMorning.jpg)";
        body.style.backgroundSize = "cover";
        body.style.backgroundPosition = "center";
    } else if (hours < 18) {
        hello.innerHTML = "Good afternoon,";
        body.style.backgroundImage = "url(001momentumAfternoon.jpg)";
        body.style.backgroundSize = "cover";
        body.style.backgroundPosition = "center";
        body.style.color = "white";
    } else {
        hello.innerHTML = "Good evening,";
        body.style.backgroundImage = "url(001momentumNight.jpg)";
        body.style.backgroundSize = "cover";
        body.style.backgroundPosition = "center";
        body.style.color = "white";
    }
