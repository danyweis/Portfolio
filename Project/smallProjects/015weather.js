    ...
    methods: {
        ...
        windDirection: function () {
            if (this.weather.wind.deg >= 337.5 || this.weather.wind.deg < 22.5) {
                return 'N'
            } else if (this.weather.wind.deg >= 22.5 || this.weather.wind.deg < 67.5) {
                return 'NE'
            } else if (this.weather.wind.deg >= 67.5 || this.weather.wind.deg < 112.5) {
                return 'E'
            } else if (this.weather.wind.deg >= 112.5 || this.weather.wind.deg < 157.5) {
                return 'SE'
            } else if (this.weather.wind.deg >= 157.5 || this.weather.wind.deg < 202.5) {
                return 'S'
            } else if (this.weather.wind.deg >= 202.5 || this.weather.wind.deg < 247.5) {
                return 'SW'
            } else if (this.weather.wind.deg >= 247.5 || this.weather.wind.deg < 292.5) {
                return 'W'
            } else if (this.weather.wind.deg >= 292.5 || this.weather.wind.deg < 337.5) {
                return 'NW'
            }
        },
